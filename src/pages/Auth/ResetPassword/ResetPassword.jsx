    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 font-sans">
      <div className={cardClasses}>
        <div className="text-center mb-8">
          ...
          <h1
            className={`text-2xl font-black ${textMain} uppercase tracking-tight`}
          >
            Nueva Contraseña
          </h1>
          <p className={`${textMuted} text-sm mt-2 font-medium`}>
            Creá una clave segura para tu cuenta.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="space-y-1">
            ...
            {errors.password && (
              <span className="text-rose-500 text-[10px] ml-1 flex items-center gap-1 font-bold">
          ...
          >
            {loading ? (
              ...
              <>
                Actualizar Clave <CheckCircle size={18} />
              </>
            )}
          </button>
        </form>
