      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Deja de adivinar. KRONIX transforma tus turnos en datos para que
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <motion.div
            whileHover={{ y: -5 }}
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 p-8 rounded-3xl hover:border-indigo-500/50 transition-colors group"
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm">
              Visualizá tu facturación estimada del mes basada en las reservas
              futuras.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm">
              Descubrí qué servicios te generan más ganancia por hora trabajada.
            </p>
          </motion.div>
          <motion.div
            whileHover={{ y: -5 }}
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm">
              Identificá a tus clientes VIP y detectá automáticamente a los
              inactivos.
            </p>
          </motion.div>
        </div>
