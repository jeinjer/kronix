    ...
    <section id="features" className="py-32 px-6 relative scroll-mt-24">
       <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
             <motion.div whileHover={{ y: -5 }} className="bg-slate-900 border border-white/5 p-8 rounded-3xl hover:border-indigo-500/50 transition-colors group">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Proyección de Ingresos</h3>
                <p className="text-slate-400 text-sm">Visualizá tu facturación estimada del mes basada en las reservas futuras.</p>
             </motion.div>
             <motion.div whileHover={{ y: -5 }} className="bg-slate-900 border border-white/5 p-8 rounded-3xl hover:border-indigo-500/50 transition-colors group">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Servicios Rentables</h3>
                <p className="text-slate-400 text-sm">Descubrí qué servicios te generan más ganancia por hora trabajada.</p>
             </motion.div>
             <motion.div whileHover={{ y: -5 }} className="bg-slate-900 border border-white/5 p-8 rounded-3xl hover:border-indigo-500/50 transition-colors group">
                ...
                <p className="text-slate-400 text-sm">Identificá a tus clientes VIP y detectá automáticamente a los inactivos.</p>
             </motion.div>
          </div>
       </div>
    </section>
