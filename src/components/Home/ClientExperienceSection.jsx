...
export default function ClientExperienceSection() {
  return (
    <section className="py-24 bg-slate-100/80 dark:bg-slate-900/50 border-y border-slate-200 dark:border-white/5 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-1 md:order-2">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg mb-8 leading-relaxed">
            Eliminamos la barrera de entrada. Tus clientes reservan directo
            desde WhatsApp o Web en segundos. El bot KRONIX confirma, agenda y
            recuerda por vos.
          </p>
